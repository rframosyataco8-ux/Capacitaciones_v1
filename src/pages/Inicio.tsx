...
import { seedIfEmpty, getStats, listCapacitaciones, type Capacitacion } from '../lib/db'
                    ...
                    <div key={m.label} className="card p-5 transition-shadow hover:shadow-[var(--shadow-md)]">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="text-[28px] font-semibold mt-1.5 tracking-tight tabular-nums" style={{ color: 'var(--text)' }}>
                            {m.value}
                          </div>
                ...
                <div className="grid lg:grid-cols-5 gap-4">
                  <div className="card p-5 lg:col-span-2">
                    ...
                    <div className="flex items-end gap-3 mb-3">
                      ...
                      <span className="text-[12px] pb-1" style={{ color: 'var(--text-secondary)' }}>
                        {stats.realizadas} / {stats.sessions} sesiones
                      </span>
                    </div>
                  ...
                  <div className="card p-5 lg:col-span-3">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Link to="/cronograma" className="text-[12px] font-semibold no-underline" style={{ color: 'var(--primary-text)' }}>
                        Ver todo
                      </Link>
                    </div>
                    {proximasList.length === 0 ? (
                      ...
                      <div className="space-y-1">
                        {proximasList.map((p) => (
                          ...
                          >
                            <div
                              className="w-10 h-10 rounded-lg flex flex-col items-center justify-center shrink-0 text-[10px] font-bold"
                              style={{ background: 'var(--primary-soft)', color: 'var(--primary-text)' }}
                            >
        ...
        {sub === 'grafo' && (
          <div className="animate-in max-w-6xl">
            ...
            <div className="card p-12 min-h-[360px] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-[15px] font-semibold">Vista de grafo</p>
              <p className="text-[13px] mt-2 max-w-md" style={{ color: 'var(--text-secondary)' }}>
                Aquí se visualizarán los temas del programa conectados con sus materiales y exámenes.
